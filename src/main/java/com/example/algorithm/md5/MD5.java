...
public class MD5 {
    ...
    public static void main(String []args){
        MD5 md=new MD5();
        System.out.println("1.md5(pjm)="+md.digest("pjm"));
        MD5 md1=new MD5();
        System.out.println("2.md5(pm have milk)="+md1.digest("pmHaveMilk"));
    }
